 ...
 */
@interface OMIDWashpostAdEvents : NSObject
 ...
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDWashpostAdSession *)session error:(NSError * _Nullable * _Nullable)error;
 ...
 */
- (BOOL)loadedWithVastProperties:(OMIDWashpostVASTProperties *_Nonnull)vastProperties
