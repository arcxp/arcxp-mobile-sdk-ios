 ...
 */
@interface OMIDWashpostAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDWashpostAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDWashpostAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDWashpostAdSessionContext *)context
