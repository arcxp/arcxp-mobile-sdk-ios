 ...
 */
@interface OMIDWashpostAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDWashpostPartner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDWashpostPartner *)partner
                               ...
                               resources:(NSArray<OMIDWashpostVerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
